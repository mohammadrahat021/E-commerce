        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <a href="{{URL::to('/')}}"><img src="{{asset('frontend/images/slide-photo/logo1.jpg')}}" alt="" /></a>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                              ...
                              -------------------------------------------------------      
                                <li><a4 href="#">Phone:+8801316339263</a4></li>
                                --------------------------------------------
                                <li><a4 href="#">bdstore@gmail.com</a4></li>
                                --------------------------------------------
                                <li><a4 href="#">website:bdstore.com</a4></li>
                                --------------------------------------------
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="single-widget">
                            ...
                            -----------------------------------------------
                            <ul class="nav nav-pills nav-stacked">
                                <li><a4 href="#">BD-Store  is a  </a4></li>
                                <li><a4 href="#"></a4></li>
                                <li><a4 href="#"></a4></li>
                                <li><a4 href="#"></a4></li>
                                <li><a4 href="#"></a4></li>
                    ...
                    <div class="col-sm-3">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                -----------------------------------
                                <li><a4 href="#">bbKash:+880170000000(Personal).</a4></li>
                                ----------------------------------------------------
                                <li><a4 href="#">Rocket:+880170000000(Personal).</a4></li>
                                -----------------------------------------------------
                                <li><a4 href="#">Helpline Number:+880170000000</a4></li>
                                -----------------------------------------------------
                            </ul>
                        </div>
                    </div>
