...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Departments</span></a></li>
						<li><a href="{{URL::to('/add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Department</span></a></li>
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a>web project 2019/RAHAT</a></span>
		</p>
